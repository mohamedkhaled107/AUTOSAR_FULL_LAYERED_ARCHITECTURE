    ...
    else
    {
        ...
        for(channel_index= ZERO; channel_index<PORT_CONFIGURED_CHANNLES; ++channel_index)
        {
            ...
            else if(Port_PortChannels[channel_index].direction == PORT_PIN_IN)
            {
                ...
                if(Port_PortChannels[channel_index].resistor == PULL_UP_RESISTOR)
                {
                ...
                else if(Port_PortChannels[channel_index].resistor == PULL_DOWN_RESISTOR)
                {
...
)
{
    ...
    else if(Port_PortChannels[Pin].direction_changble == PORT_PIN_DIRECTION_UNCHANGEABLE)
    {
        Det_ReportError(PORT_MODULE_ID,
                        PORT_INSTANCE_ID,
                        PORT_INIT_SID,
        ...
        Port_PinModeType Mode )
{
    ...
    else if(Port_PortChannels[Pin].mode_changble == PORT_PIN_MODE_UNCHANGEABLE)
    {
        Det_ReportError(PORT_MODULE_ID,
                        PORT_INSTANCE_ID,
                        PORT_INIT_SID,
